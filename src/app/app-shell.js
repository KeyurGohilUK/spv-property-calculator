  ...
  root.body.insertAdjacentHTML('beforeend', `
    <dialog id="moreMenuDialog" class="install-dialog more-menu-dialog" aria-labelledby="appMenuTitle">
      ...
      <div class="more-menu-list">
        ...
        <a class="more-menu-item" href="./brrr/"><span class="more-menu-icon" aria-hidden="true">⟳</span><span><strong>BRRR Calculator</strong><small>Model offer prices and capital recycling for a buy-refurb-refinance deal</small></span><span aria-hidden="true">›</span></a>
