...
Keep the root `README.md` as the main entry point. New current operational instructions should go under `setup/`; completed plans should move to `history/` rather than returning to the repository root.
