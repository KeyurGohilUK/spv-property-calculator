...
import {
  ...
  calculateSDLT,
  safeNumber
} from '../src/features/properties/calculations.js';
...
const productionApp = fs.readFileSync(new URL('../src/app/app.js', import.meta.url), 'utf8');
assert.match(productionApp, /from '\.\.\/features\/properties\/calculations\.js'/, 'Production app must import the property calculations feature');
assert.match(productionApp, /from '\.\.\/features\/properties\/storage\.js'/, 'Production app must import the property storage feature');
